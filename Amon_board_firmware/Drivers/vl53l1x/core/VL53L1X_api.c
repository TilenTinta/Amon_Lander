...
VL53L1X_ERROR VL53L1X_SetInterruptPolarity(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint8_t NewPolarity)
{
	dev -> i2cHandle = i2cHandle;
	uint8_t Temp;
	VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_GetTimingBudgetInMs(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *pTimingBudget)
{
	dev -> i2cHandle = i2cHandle;
	uint16_t Temp;
	VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_SetDistanceMode(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t DM)
{
	dev -> i2cHandle = i2cHandle;
	uint16_t TB;
	VL53L1X_ERROR status = 0;

	status |= VL53L1X_GetTimingBudgetInMs(dev, i2cHandle, &TB);
	if (status != 0)
		return 1;
	switch (DM) {
	case 1:
	...
	if (status == 0)
		status |= VL53L1X_SetTimingBudgetInMs(dev, i2cHandle, TB);
...
VL53L1X_ERROR VL53L1X_SetInterMeasurementInMs(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint32_t InterMeasMs)
{
	dev -> i2cHandle = i2cHandle;
	uint16_t ClockPLL;
	VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_GetSensorId(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *sensorId)
{
	dev -> i2cHandle = i2cHandle;
	VL53L1X_ERROR status = 0;
	uint16_t tmp = 0;
...
VL53L1X_ERROR VL53L1X_GetSignalPerSpad(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *signalRate)
{
	dev -> i2cHandle = i2cHandle;
	VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_GetAmbientPerSpad(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *ambPerSp)
{
	dev -> i2cHandle = i2cHandle;
	VL53L1X_ERROR status = 0;
...
VL53L1X_ERROR VL53L1X_GetSignalRate(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *signal)
{
	dev -> i2cHandle = i2cHandle;
	VL53L1X_ERROR status = 0;
	uint16_t tmp;
...
VL53L1X_ERROR VL53L1X_GetSigmaThreshold(VL53L1_DEV *dev, I2C_HandleTypeDef *i2cHandle, uint16_t *sigma)
{
	dev -> i2cHandle = i2cHandle;
	VL53L1X_ERROR status = 0;
	uint16_t tmp;
