...
from model_numpy.simulation.plotting import plot_servo_response
from model_numpy.simulation.simulator import simulate_servo

params = AmonParams()

# load data - csv file
_AMON_DIR = Path(__file__).resolve().parents[2]
...
# -------------------------------- MAIN --------------------------------
# Run code: python -m model_numpy.simulation.identification_servo
t = time - time[0]
