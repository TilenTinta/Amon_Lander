...
from model_numpy.full_dynamic import full_dynamics_2nd_order
from model_numpy.actuators import delay_buffer, edf_block, edf_block_2nd_order, servo_block_2nd_order
from model_numpy.simulation.intergrators import rk4_step
...
def simulate(x0, U, dt, params):
    ...
    for k in range(n_steps):
        ...
        x = rk4_step(full_dynamics_2nd_order, x, u, dt, params)
