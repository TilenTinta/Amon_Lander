...
def edf_block_2nd_order(T, T_dot, edf_cmd, delay_buffer, params):
    ...
    Warning:
        - Mogoče ga zamenjaj za instant kot ker drugače pri dt=0.01 in wn_up_edf > 1k dobiš nerešljivo optimizacijo
          Previsoka naravna frekvenca → stiff system → RK4 nestabilen → IPOPT ne konvergira
    """
...
def servo_block_2nd_order(delta, delta_dot, servo_cmd_deg, delay_buffer, params, servo_offset_rad=0.0):
    ...
    Warning:
        - Mogoče ga zamenjaj za instant kot ker drugače pri dt=0.01 in wn_up_servo > 1k rad/s dobiš nerešljivo optimizacijo
          Previsoka naravna frekvenca → stiff system → RK4 nestabilen → IPOPT ne konvergira    
    """
